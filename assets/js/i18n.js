...
(function () {
  ...
  var dict = {
    en: {
      ...
      "hero.stat2.value": "+1500",
      "hero.stat3.label": "Events / semester",
      "hero.stat3.value": "~4",
      ...
      "eventsUpcoming.lede": "This is where we share the next dates to meet, dance and enjoy the community together in Zurich.",
      ...
      "eventsUpcoming.freeEntry": "Free entry · No ticket required",
      ...
      "staff.study.mechanical": "MSc Mechanical Engineering",
      "staff.study.computer": "BSc Computer Science",
      "staff.study.mathematics": "BSc Mathematics",
      "staff.study.process": "MSc Process Engineering",
      "staff.study.architecture": "BSc Architecture",
      "staff.study.health": "BSc Health Sciences",
      "staff.groupPhoto": "Full team photo",

      "join.kicker": "Join us",
      "join.title": "Become a member",
      "join.lede": "Join LSVZ and stay close to Zurich's Latin American and Spanish-speaking community.",
    ...
    es: {
      ...
      "hero.stat2.value": "+1500",
      "hero.stat3.label": "Eventos / semestre",
      "hero.stat3.value": "~4",
      ...
      "eventsUpcoming.lede": "Aquí publicamos las próximas fechas para encontrarnos, bailar y compartir comunidad en Zúrich.",
      ...
      "eventsUpcoming.freeEntry": "Entrada libre · No necesitas ticket",
      ...
      "staff.study.mechanical": "MSc Ingeniería Mecánica",
      "staff.study.computer": "BSc Informática",
      "staff.study.mathematics": "BSc Matemáticas",
      "staff.study.process": "MSc Ingeniería de Procesos",
      "staff.study.architecture": "BSc Arquitectura",
      "staff.study.health": "BSc Ciencias de la Salud",
      "staff.groupPhoto": "Foto de equipo completo",

      "join.kicker": "Únete",
      "join.title": "Hazte miembro",
      "join.lede": "Forma parte de LSVZ y mantente cerca de la comunidad latina e hispanohablante de Zúrich.",
    ...
    de: {
      ...
      "eventsUpcoming.lede": "Hier teilen wir die nächsten Termine, um uns in Zürich zu treffen, zu tanzen und gemeinsam Zeit zu verbringen.",
      ...
      "eventsUpcoming.freeEntry": "Freier Eintritt · Kein Ticket nötig",
      ...
      "staff.study.mechanical": "MSc Maschinenbau",
      "staff.study.computer": "BSc Informatik",
      "staff.study.mathematics": "BSc Mathematik",
      "staff.study.process": "MSc Verfahrenstechnik",
      "staff.study.architecture": "BSc Architektur",
      "staff.study.health": "BSc Gesundheits\u00ADwissenschaften",
      "staff.groupPhoto": "Foto des ganzen Teams",

      "join.kicker": "Mach mit",
      "join.title": "Mitglied werden",
      "join.lede": "Werde Teil von LSVZ und bleib mit der lateinamerikanischen und spanischsprachigen Community in Zürich verbunden.",
