...
(function () {
  ...
  var dict = {
    en: {
      ...
      "homeNotice.label": "Upcoming event",
      "homeNotice.kicker": "NEXT UP",
      "homeNotice.tickets": "Tickets available",
      "homeNotice.free": "Free entry",
      "homeNotice.soon": "See event details",
      "homeNotice.cta": "See upcoming events",
      "homeNotice.close": "Close event notice",
    ...
    es: {
      ...
      "homeNotice.label": "Próximo evento",
      "homeNotice.kicker": "PRÓXIMO ENCUENTRO",
      "homeNotice.tickets": "Entradas disponibles",
      "homeNotice.free": "Entrada libre",
      "homeNotice.soon": "Consulta los detalles",
      "homeNotice.cta": "Ver próximos eventos",
      "homeNotice.close": "Cerrar aviso",
    ...
    de: {
      ...
      "homeNotice.label": "Kommendes Event",
      "homeNotice.kicker": "ALS NÄCHSTES",
      "homeNotice.tickets": "Tickets verfügbar",
      "homeNotice.free": "Eintritt frei",
      "homeNotice.soon": "Eventdetails ansehen",
      "homeNotice.cta": "Kommende Events ansehen",
      "homeNotice.close": "Event-Hinweis schliessen",
